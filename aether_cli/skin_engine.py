"""AETHER CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.aether/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "AETHER"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ AETHER "       # Response box header label
...
.. code-block:: python
    ...
    from aether_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "AETHER"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.aether/skins/
...
Drop a YAML file in ``~/.aether/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces AETHER_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces AETHER_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic AETHER — gold and kawaii",
        "colors": {
