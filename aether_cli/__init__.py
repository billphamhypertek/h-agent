"""
AETHER CLI - Unified command-line interface for AETHER.

Provides subcommands for:
- aether chat          - Interactive chat (same as ./aether)
- aether gateway       - Run gateway in foreground
- aether gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `aether setup` on a fresh Pi.
    ...
    aether_cli/stdio.py::configure_windows_stdio() runs later from the entry
