"""``aether tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'aether tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # aether tools list [--platform cli]
    ...
    # aether tools disable <name...> [--platform cli]
    ...
    # aether tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `aether tools` runs after you pick a provider that\n"
