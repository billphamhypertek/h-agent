"""``aether import`` subcommand parser.
...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import",
        help="Restore a AETHER backup from a zip file",
        description="Extract a previously created AETHER backup into your "
        "AETHER home directory, restoring configuration, skills, "
        "sessions, and data",
    )
