...
Entry point: ``aether whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``aether_cli/main.py``).
...
AETHER gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures AETHER to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  AETHER needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the AETHER gateway in another terminal:")
    print("         aether gateway")
    print()
    ...
    print()
    print("  Docs: https://aether.hypertek.vn/docs/user-guide/")
