...
into prompt_toolkit's event loop. Each function takes the AetherCLI instance
...
from aether_cli.banner import cprint, _DIM, _RST
...
def prompt_for_secret(cli, var_name: str, prompt: str, metadata=None) -> dict:
    ...
    The secret is stored in ~/.aether/.env and never exposed to the model.
    """
