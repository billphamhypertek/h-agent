...
Invoked by ``aether kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the AETHER board.
...
def _profile_author() -> str:
    """Mirror of ``aether_cli.kanban._profile_author``."""
    return (
