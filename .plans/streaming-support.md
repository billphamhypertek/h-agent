# Streaming LLM Response Support for AETHER
...
```
AETHER_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("AETHER_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `aether_cli/config.py` | 1 | +streaming config defaults |
