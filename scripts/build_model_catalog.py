#!/usr/bin/env python3
"""Build the AETHER Model Catalog — a centralized JSON manifest of curated models.
...
AETHER CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a AETHER release.
...
# Ensure AETHER_HOME is set for imports that touch it at module level.
os.environ.setdefault("AETHER_HOME", os.path.join(os.path.expanduser("~"), ".aether"))

from aether_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "aether-agent repo",
            "docs": "https://aether.hypertek.vn/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
