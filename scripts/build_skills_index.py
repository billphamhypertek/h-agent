#!/usr/bin/env python3
"""Build the AETHER Skills Index — a centralized JSON catalog of all skills.
...
`aether skills search/install` can use it without hitting the GitHub API.
...
# Ensure AETHER_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building AETHER Skills Index...", flush=True)
