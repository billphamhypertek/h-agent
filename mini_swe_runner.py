#!/usr/bin/env python3
"""
SWE Runner with AETHER Trajectory Format

A runner that uses AETHER-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the AETHER-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses AETHER-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in AETHER format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches AETHER-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using AETHER-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with AETHER Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses AETHER-Agent's built-in execution environments
    and outputs trajectories in AETHER-Agent format.
    """
    ...
    def _convert_to_aether_format(
        ...
        """
        Convert internal message format to AETHER trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to AETHER trajectory format
        trajectory = self._convert_to_aether_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with AETHER trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with AETHER Trajectory Format")
    print("=" * 60)
