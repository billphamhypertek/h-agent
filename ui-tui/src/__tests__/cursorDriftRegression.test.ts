 ...
 *
 * Symptom: in `aether --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@aether/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using aether --tui and as i type multiline my caret at the end will often ' +
