...
import type { ScrollBoxHandle } from '@aether/ink'
import { evictInkCaches } from '@aether/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.AETHER_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
