...
const STORAGE_KEY = "aether-dashboard-theme";
...
const FONT_STORAGE_KEY = "aether-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `aether_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "aether-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-aether-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-aether-theme-font", "true");
