 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `aether_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "AETHER Teal",
  description: "Classic dark teal — the canonical AETHER look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" AETHER look, ported from the
 ...
 * nousnet-web's <body> is white; aether-agent's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "AETHER Teal (Large)",
  description: "AETHER Teal with bigger fonts and roomier spacing",
