          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="aether-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="aether-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({
  ...
  const { activeAction, isBusy, isRunning, pendingAction, runAction } =
    useSystemActions();
  const canUpdateAETHER = status?.can_update_aether === true;
  ...
  if (canUpdateAETHER) {
    items.push({
      action: "update",
      icon: Download,
      label: t.status.updateAETHER,
      runningLabel: t.status.updatingAETHER,
      spin: false,
    });
  }
