/**
 * AETHER Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__AETHER_PLUGIN_SDK__`` and
 * ``window.__AETHER_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__AETHER_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``AetherPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@aether/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__AETHER_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__AETHER_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__AETHER_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface AetherPluginSDK {
...
declare global {
  interface Window {
    __AETHER_PLUGIN_SDK__?: AetherPluginSDK;
    __AETHER_PLUGINS__?: PluginRegistry;
  }
}
