 ...
 * `window.__AETHER_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the AETHER brand in the top bar
 ...
 *  `window.__AETHER_PLUGINS__.registerSlot(...)`.
 *
