 ...
 *
 * Plugins call window.__AETHER_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__AETHER_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__AETHER_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__AETHER_PLUGIN_SDK__ = {
    ...
    // window.__AETHER_SESSION_TOKEN__ directly.
    authedFetch,
