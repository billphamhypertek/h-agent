...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateAETHER: "Werk AETHER op",
    updatingAETHER: "Besig om AETHER op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk AETHER-inproppe op (`aether plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.aether/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.aether/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.aether/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare AETHER-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "AETHER-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik AETHER meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra AETHER 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "AETHER skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
