 ...
 *
 * Values mirror aether_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the AETHER default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (AETHER' default when unset). */
