...
to a generic "Your API key was rejected... run aether setup" message, which is
...
def test_nous_401_guidance_strings_present():
    ...
    # Must give a concrete re-auth command, not a generic "aether setup".
    assert "aether portal" in source
