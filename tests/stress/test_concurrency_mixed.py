...
def worker_loop(worker_id: int, aether_home: str, result_file: str) -> None:
...
def reclaimer_loop(aether_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="aether_mixed_stress_")
    print(f"AETHER_HOME = {home}")
