"""Tests for the interactive session browser (`aether sessions browse`).
...
from aether_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """aether sessions browse should be parseable."""
