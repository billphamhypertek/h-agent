...
The main() function in aether_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `aether -c model`
...
def _build_parser():
    """Build a minimal replica of the aether top-level parser."""
