...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from aether_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in AETHER_OVERLAYS
        overlay = AETHER_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify aether doctor recognizes Xiaomi env vars."""
