"""Tests for the specifier module + `aether kanban specify` CLI surface.
...
from aether_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `aether kanban …` argparse surface directly."""
