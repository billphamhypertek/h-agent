...
The unit tests in tests/aether_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned aether-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/aether")
from aether_cli.service_manager import S6ServiceManager
