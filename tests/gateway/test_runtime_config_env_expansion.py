...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("AETHER_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("AETHER_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("AETHER_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
