...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.aether/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at aether_state import time, before pytest's AETHER_HOME monkeypatch
    fires — the autouse fixture's AETHER_HOME override doesn't help here.)
    """
    import aether_state
