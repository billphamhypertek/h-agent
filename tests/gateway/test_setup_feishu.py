"""Tests for _setup_feishu() in aether_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("aether_cli.config.save_env_value", side_effect=mock_save), \
         patch("aether_cli.config.get_env_value", side_effect=mock_get), \
         patch("aether_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("aether_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("aether_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("aether_cli.cli_output.print_header"), \
         patch("aether_cli.cli_output.print_info"), \
         patch("aether_cli.cli_output.print_success"), \
         patch("aether_cli.cli_output.print_warning"), \
         patch("aether_cli.cli_output.print_error"), \
