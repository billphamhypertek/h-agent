# AETHER Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.aether/plugins/aether-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.aether/plugins/aether-achievements/scan_checkpoint.json`.
