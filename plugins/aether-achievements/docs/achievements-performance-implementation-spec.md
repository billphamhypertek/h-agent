# AETHER Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.aether/plugins/aether-achievements/state.json` (existing unlock state)
  - `~/.aether/plugins/aether-achievements/scan_snapshot.json` (new)
  - `~/.aether/plugins/aether-achievements/scan_checkpoint.json` (new)
