...
Config: ~/.aether/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.aether/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_aether_home()`` helper (AETHER_HOME-aware and
...
RULES_FILE = get_aether_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_aether_home() / "feishu_comment_pairing.json"
