...
required — uses aiohttp which is already a AETHER dependency.
...
def interactive_setup() -> None:
    ...
    ``aether_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where AETHER delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # aether_cli/setup.py::_setup_mattermost function.
