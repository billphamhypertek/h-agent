...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> AETHER gateway adapter.

    Each inbound phone number gets its own AETHER session (multi-tenant).
...
# static dict in aether_cli/gateway.py, and the _send_sms dispatch in
