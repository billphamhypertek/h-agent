...
``_check_spotify_available()`` — when the user has not run ``aether auth
spotify``, the tools remain registered (so they appear in ``aether
...
The Spotify auth flow (``aether auth spotify``), CLI plumbing, and docs
