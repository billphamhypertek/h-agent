...
try:
    ...
    _AETHER_VERSION = "0.0.0"

_APP_VERSION = _AETHER_VERSION
_BOT_VERSION = _AETHER_VERSION
_YUANBAO_INSTANCE_ID = str(AETHER_INSTANCE_ID)  # single source: yuanbao_proto.AETHER_INSTANCE_ID
