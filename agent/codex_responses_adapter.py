...
# output items.  AETHER injects xAI's native ``web_search`` for the xAI
...
def _chat_messages_to_responses_input(
    ...
    *,
    ...
    explicitly relies on AETHER threading encrypted reasoning back across
                ...
                if isinstance(codex_reasoning, list):
                    for ri in codex_reasoning:
                        if isinstance(ri, dict) and ri.get("encrypted_content"):
                            ...
                            # it is a AETHER-side metadata key and not part
