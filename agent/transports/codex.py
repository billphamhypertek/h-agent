...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around AETHER's web-provider config and
        ...
        # native search engine for xAI sessions instead of AETHER's
        # configured web provider (Tavily/etc.), and those results bypass
        # AETHER's tool-trace / citation plumbing (they arrive baked into the
