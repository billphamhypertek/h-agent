...
(3 SDK retries x 3 AETHER retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_aether_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".aether")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, AETHER, ...) behind one endpoint.  A 429 can mean either:
