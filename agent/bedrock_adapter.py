"""AWS Bedrock Converse API adapter for AETHER.
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install AETHER with Bedrock support: pip install -e '.[bedrock]'"
        )
    # converse() / converse_stream() were added in boto3 1.34.59.
    # When AETHER is installed editable into system Python, the system boto3
