...
{ ... }:
{
  perSystem =
    ...
    let
      ...
      aetherNpmLib = self'.packages.default.passthru.aetherNpmLib;
      ...
      # Non-npm packages may have their own devShellHook (e.g. aether-agent
    ...
    in
    {
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "AETHER dev shell"
          ${combinedNonNpm}
          ${aetherNpmLib.mkNpmDevShellHook npmPackageJsonPaths}
          echo "Ready. Run 'aether' to start."
        '';
      };
    };
}
