# nix/web.nix — AETHER Web Dashboard (Vite/React) frontend build
{ pkgs, aetherNpmLib, ... }:
let
  npm = aetherNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "aether-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../aether_cli/web_dist for the
