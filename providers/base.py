...
def _profile_user_agent() -> str:
    """Return a ``aether-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from aether_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"aether-cli/{_ver}"
    except Exception:
        return "aether-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # aether-cli UA so the catalog endpoint is reachable.
