...
cd apps/desktop
XCURSOR_SIZE=24 AETHER_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/aether-typing
# → /tmp/aether-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/aether-typing.before.heapsnapshot
# → /tmp/aether-typing.after.heapsnapshot
```
