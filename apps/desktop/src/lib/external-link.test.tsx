...
const desktopWindow = window as unknown as { aetherDesktop?: Window['aetherDesktop'] }
const initialAetherDesktop = desktopWindow.aetherDesktop

function installDesktopBridge(partial: Partial<Window['aetherDesktop']> = {}) {
  desktopWindow.aetherDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['aetherDesktop']
}
...
afterEach(() => {
  ...
  if (initialAetherDesktop) {
    desktopWindow.aetherDesktop = initialAetherDesktop
  } else {
    delete desktopWindow.aetherDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['aetherDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['aetherDesktop']['openExternal'] })
