...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|aether):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.aetherDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.aetherDesktop?.openExternal?.(href)
  }
}
