...
export const en: Translations = {
  ...
  boot: {
    ready: 'AETHER Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading AETHER settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingAetherDesktop: 'Starting AETHER Desktop…'
    },
    errors: {
      backgroundExited: 'AETHER background process exited.',
      backgroundExitedDuringStartup: 'AETHER background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your AETHER backend is older than this desktop build and may not work correctly. Update to align them.',
    updateAETHER: 'Update AETHER',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting AETHER Desktop.',
    ...
    native: {
      ...
      inputBody: 'AETHER is waiting for your response.',
      turnDoneTitle: 'AETHER finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to AETHER defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while AETHER is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'AETHER asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while AETHER was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let AETHER follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what AETHER is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen AETHER, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'AETHER checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading AETHER configuration...',
    ...
    gateway: {
      ...
      intro:
        'AETHER Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running AETHER backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset AETHER_DESKTOP_REMOTE_URL and AETHER_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private AETHER backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote AETHER backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /aether.',
      ...
      restartingMessage: 'AETHER Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · AETHER ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. AETHER runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart AETHER to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update AETHER to generate pets.',
      backgroundHint: 'You can close this — AETHER will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure AETHER desktop' },
    ...
    aetherActiveSessions: (version, count) => `AETHER ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@aether:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent AETHER environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. AETHER will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting AETHER...',
    placeholderReconnecting: 'Reconnecting to AETHER…',
    ...
    attachUrlDesc: 'AETHER will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating AETHER…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting AETHER…',
    ...
    unsupportedMessage: 'This version of AETHER can’t update itself from inside the app.',
    ...
    manualBody: 'You installed AETHER from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'AETHER will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the AETHER desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The AETHER updater takes over in its own window and reopens AETHER automatically when it’s done. Please don’t reopen AETHER yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. AETHER reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then AETHER reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'AETHER needs a one-time install',
    ...
    settingUpTitle: 'Setting up AETHER',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another AETHER CLI or desktop instance is running. Stop any running AETHER instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The AETHER installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with AETHER",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'AETHER is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting AETHER…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run AETHER',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point AETHER at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — AETHER connects automatically',
      loopback: 'Opens your browser to sign in — AETHER connects automatically',
    ...
    authorizeThere: 'Authorize AETHER there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize AETHER there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'AETHER inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. AETHER will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'AETHER is restarting...',
      askRestart: 'Ask AETHER to restart the server',
      lookingRestart: taskId => `AETHER is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'AETHER is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `AETHER finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'AETHER could not restart the server.',
      stillWorking:
        'AETHER is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'AETHER is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'AETHER gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.aether/config.yaml). AETHER won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'AETHER needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'AETHER needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart AETHER Desktop to use Save Image.',
    restartToSaveImages: 'Restart AETHER Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `aether gateway` running?'
    }
  },
