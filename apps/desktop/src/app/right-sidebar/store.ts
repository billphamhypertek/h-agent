...
const TAKEOVER_KEY = 'aether.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which AETHER can't clear via the API — the user
 *  sees exactly what runs instead of AETHER silently deleting their creds. */
