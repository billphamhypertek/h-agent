import type { AetherConfigRecord, ToolsetInfo } from '@/types/aether'
...
export function getNested(obj: AetherConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: AetherConfigRecord, path: string, value: unknown): AetherConfigRecord {
...
function personalityOptions(config: AetherConfigRecord): string[] {
