...
import { getAetherConfigRecord, type AetherGateway, saveAetherConfig } from '@/aether-api'
...
function getServers(config: AetherConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveAetherConfig(nextConfig)
