...
// / Program Files), which buried any files AETHER wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.aetherDesktop` is
    ...
    const settings = window.aetherDesktop?.settings
