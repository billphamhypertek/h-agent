...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/aether'
 ...
 * log inline — the GUI equivalent of the install step `aether tools` runs
