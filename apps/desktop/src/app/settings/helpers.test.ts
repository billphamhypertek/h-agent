...
describe('settings helpers', () => {
  ...
  it('reads and writes nested config paths', () => {
    const config: AetherConfigRecord = { display: { theme: 'mono' } }
  ...
  it('rejects prototype-polluting config paths', () => {
    const config: AetherConfigRecord = {}
  ...
  describe('providerGroup', () => {
    ...
    it('prefers the longest matching prefix so CN/regional buckets win', () => {
      ...
      // AETHER_QWEN_ shares the AETHER_ stem with other integrations.
      expect(providerGroup('AETHER_QWEN_BASE_URL')).toBe('DashScope (Qwen)')
