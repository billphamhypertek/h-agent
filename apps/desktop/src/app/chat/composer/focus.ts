...
const FOCUS_EVENT = 'aether:composer-focus'
const INSERT_EVENT = 'aether:composer-insert'
const INSERT_REFS_EVENT = 'aether:composer-insert-refs'
const VOICE_TOGGLE_EVENT = 'aether:composer-voice-toggle'
