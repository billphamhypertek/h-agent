...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/aether-api'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('aether:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('aether:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
