...
def auth_json_path():
    """Return the AETHER auth store path, respecting AETHER_HOME overrides."""
    return get_aether_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`aether tools`, banner/status paint, provider
