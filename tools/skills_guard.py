...
Trust levels:
  - builtin:   Ships with AETHER. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.aether/\.env|\~/\.aether/\.env',
     "aether_env_access", "critical", "exfiltration",
     "directly references AETHER secrets file"),
    ...
    (r'\.aether/config\.yaml|\.aether/SOUL\.md',
     "aether_config_mod", "critical", "persistence",
     "references AETHER configuration files directly"),
...
# scan. `.skillignore` is the AETHER-native name; `.clawhubignore` is honored
