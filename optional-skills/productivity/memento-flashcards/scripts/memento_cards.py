...
Data file: $AETHER_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_AETHER_HOME = Path(os.environ.get("AETHER_HOME", Path.home() / ".aether"))
DATA_DIR = _AETHER_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
