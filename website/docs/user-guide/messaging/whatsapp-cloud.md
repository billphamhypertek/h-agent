...
Message-template support (the workaround for outside-window sends) is not yet implemented in AETHER. If you need it, please [open an issue](https://github.com/billphamhypertek/h-agent/issues) — it's planned but waiting on a clear demand signal.
