...
| | |
|---|---|
| Source | Optional — install with `aether skills install official/research/qmd` |
...
AETHER via the native MCP client. This is the preferred
...
Then configure AETHER to connect via HTTP:
