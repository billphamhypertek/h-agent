...
| | |
|---|---|
| Source | Optional — install with `aether skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | AETHER (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $AETHER_OSINT_CACHE/icij/ (default: ~/.cache/aether-osint/icij/).
...
# Set AETHER_OSINT_UA=your-app/1.0 (your@email) to identify yourself
