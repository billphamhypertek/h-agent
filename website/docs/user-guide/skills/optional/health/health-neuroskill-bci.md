...
| | |
|---|---|
| Source | Optional — install with `aether skills install official/health/neuroskill-bci` |
...
Connect AETHER to a running [NeuroSkill](https://neuroskill.com/) instance to read
