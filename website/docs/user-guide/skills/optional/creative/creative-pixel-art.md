...
| | |
|---|---|
| Source | Optional — install with `aether skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.aether/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.aether/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — AETHER installs package this)
