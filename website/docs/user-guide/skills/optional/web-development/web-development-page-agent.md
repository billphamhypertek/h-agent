...
- User wants **AETHER itself to drive a browser** → use AETHER' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
