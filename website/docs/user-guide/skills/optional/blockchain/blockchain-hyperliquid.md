...
| | |
|---|---|
| Source | Optional — install with `aether skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), AETHER |
| License | MIT |
...
The script reads `${AETHER_HOME:-~/.aether}/.env` for two optional defaults:
...
Helper script: `~/.aether/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.aether/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${AETHER_HOME:-~/.aether}/.env`.
...
```bash
python3 ~/.aether/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.aether/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
