...
| | |
|---|---|
| Source | Optional — install with `aether skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), AETHER |
| License | MIT |
...
Helper script path: `~/.aether/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.aether/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.aether/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.aether/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
