...
| | |
|---|---|
| Source | Optional — install with `aether skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), AETHER |
| License | MIT |
...
```
SCRIPT=~/.aether/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.aether/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
