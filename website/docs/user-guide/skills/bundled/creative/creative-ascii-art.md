...
```bash
python3 -m pyfiglet "AETHER" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=AETHER&font=Slant" | boxes -d stone
```
