...
If you find a bug, [open an issue](https://github.com/billphamhypertek/h-agent/issues) with the output of `aether logs --since 5m`. Mention `codex-runtime` in the title so it's easy to triage.
