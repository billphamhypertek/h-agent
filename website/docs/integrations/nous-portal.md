...
If a model is genuinely missing, [open an issue](https://github.com/billphamhypertek/h-agent/issues) — we surface the Portal's catalog to AETHER and gaps usually mean a routing config we can update.
