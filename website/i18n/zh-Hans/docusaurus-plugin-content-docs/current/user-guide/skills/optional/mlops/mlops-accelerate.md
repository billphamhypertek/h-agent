...
| | |
|---|---|
| 来源 | 可选 — 通过 `aether skills install official/mlops/accelerate` 安装 |
...
**Megatron 集成**：张量并行、流水线并行和序列并行的配置，请参阅 [references/megatron-integration.md](https://github.com/billphamhypertek/h-agent/blob/main/optional-skills/mlops/accelerate/references/megatron-integration.md)。

**自定义插件**：创建自定义分布式插件及高级配置，请参阅 [references/custom-plugins.md](https://github.com/billphamhypertek/h-agent/blob/main/optional-skills/mlops/accelerate/references/custom-plugins.md)。

**性能调优**：性能分析、内存优化及最佳实践，请参阅 [references/performance.md](https://github.com/billphamhypertek/h-agent/blob/main/optional-skills/mlops/accelerate/references/performance.md)。
