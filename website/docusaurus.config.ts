...
const config: Config = {
  ...
  url: 'https://aether.hypertek.vn',
  baseUrl: '/docs/',

  organizationName: 'NousResearch',
  projectName: 'aether-agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/billphamhypertek/h-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/aether-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/billphamhypertek/h-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/billphamhypertek/h-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://aether.hypertek.vn/' },
            { label: 'GitHub', href: 'https://github.com/billphamhypertek/h-agent' },
