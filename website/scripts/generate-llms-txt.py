#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the AETHER docs site.
...
Both publish at:
  https://aether.hypertek.vn/docs/llms.txt
  https://aether.hypertek.vn/docs/llms-full.txt
...
SITE_BASE = "https://aether.hypertek.vn/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use AETHER as a Python Library", None),
        ("guides/use-mcp-with-aether", "Use MCP with AETHER", None),
        ("guides/use-voice-mode-with-aether", "Use Voice Mode with AETHER", None),
        ("guides/use-soul-with-aether", "Use SOUL.md with AETHER", None),
        ("guides/build-a-aether-plugin", "Build a AETHER Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with AETHER"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "aether-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/billphamhypertek/h-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# AETHER — Full Documentation\n",
        (
            "This file is the entire AETHER documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using AETHER, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://aether.hypertek.vn/docs\n",
        "Short index: https://aether.hypertek.vn/docs/llms.txt\n",
        "\n---\n\n",
    ]
